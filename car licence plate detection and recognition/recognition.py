...
class CardPredictor:
	def __init__(self):
		...
		for c in j["config"]:
			...
			raise RuntimeError('No valid configuration parameters are set')
	...
	def predict(self, car_pic):
		...
		return predict_result, roi, card_colorcaca

if __name__ == '__main__':
	c = CardPredictor()
	c.train_svm()
	# path = '/Users/isaaczhang/Documents/programming/License-Plate-Recognition/test/test.jpg'
	r, roi, color = c.predict("test_5.jpg")
	print(r)
